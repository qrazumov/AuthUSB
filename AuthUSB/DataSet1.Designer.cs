...
namespace AuthUSB {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentRow AddstudentRow(long id, string name, string lastname, string _group) {
...
namespace AuthUSB.DataSet1TableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""main"".""student"" WHERE ((""id"" = :Original_id) AND ((:IsNull_name = 1 AND ""name"" IS NULL) OR (""name"" = :Original_name)) AND ((:IsNull_lastname = 1 AND ""lastname"" IS NULL) OR (""lastname"" = :Original_lastname)) AND ((:IsNull__group = 1 AND ""_group"" IS NULL) OR (""_group"" = :Original__group)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"main\".\"student\" (\"id\", \"name\", \"lastname\", \"_group\") VALUES (:id, :n" +
                "ame, :lastname, :_group)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""main"".""student"" SET ""id"" = :id, ""name"" = :name, ""lastname"" = :lastname, ""_group"" = :_group WHERE ((""id"" = :Original_id) AND ((:IsNull_name = 1 AND ""name"" IS NULL) OR (""name"" = :Original_name)) AND ((:IsNull_lastname = 1 AND ""lastname"" IS NULL) OR (""lastname"" = :Original_lastname)) AND ((:IsNull__group = 1 AND ""_group"" IS NULL) OR (""_group"" = :Original__group)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, lastname, _group FROM \"main\".student";
        ...
        public virtual int Delete(long Original_id, string Original_name, string Original_lastname, string Original__group) {
        ...
        public virtual int Insert(long id, string name, string lastname, string _group) {
        ...
        public virtual int Update(long id, string name, string lastname, string _group, long Original_id, string Original_name, string Original_lastname, string Original__group) {
            ...
            if ((Original__group == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original__group));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string lastname, string _group, long Original_id, string Original_name, string Original_lastname, string Original__group) {
            return this.Update(Original_id, name, lastname, _group, Original_id, Original_name, Original_lastname, Original__group);
        }
    }
